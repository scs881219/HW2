...
class FlowerDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Detailed information"
        ...
        currentFlowerId?.let {
            ...
            if (currentFlower?.image2 == null) {
                flowerImage.setImageResource(R.drawable.baseball_photo)
            } else {
                flowerImage.setImageResource(currentFlower.image2)
            }
